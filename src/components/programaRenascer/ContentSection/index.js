...
const ContentSection = () => {
    ...
    const questionsAndAnswers = [
        ...
        },
        {
            ...
            content: (
                <>
                    ...
                    <p> 3. Aceitar os termos dos “Compromissos dos membros do grupo” </p>
                </>
            )
        },
        {
            ...
            content: (
                <>
                    ...
                    <p> 1.As dependências têm raízes no Espírito. O Espírito é a sede
                      ...
                      essência do ser. </p>
                    <p> 2. Se a raíz da dependência está no espírito, a cura só pode vir
                      de dentro para fora. Assim, a rigor somente existe autocura e nós
                      somos agentes (e não pacientes) da nossa própria cura. </p>
                    <p> 3. O “remédio” seguro para a nossa autocura é a autoeducação, através
                    ...
                    <p> 5. Incentivos ao hábito da oração com o duplo objetivo: restabelecer o
                      contato com Deus e com as forças Espirituais superiores; Evitar a
                      sintonia inferior. </p>
            ...
            content: (
                <>
                    ...
                    <p> Para usufruir dos benefícios do programa, basta que o participante
                      ...
                      oferece subsídios para que aprendamos a viver dentro desses princípios.
        ...
        },
        {
            ...
            content: (
                <>
                    ...
                    <p> A reforma íntima, portanto, vem do autoconhecimento e da autoeducação.
        ...
        {
            key: 7,
            title: 'Mas enquanto o participante não atinge esse estágio de busca da reforma íntima, ' +
             'como o Programa o ajuda a se manter afastado dos vícios?',
            content: (
                <>
                    ...
                    <p> Não podemos nos esquecer, no entanto, que um tratamento espiritual
                      está sendo feito paralelamente, com o objetivo de nos aliviar do assédio
                      espiritual e ainda de desintoxicar o nosso corpo perispiritual. Além
            ...
            content: (
                <>
                    ...
                    <p> Justamente para evitarmos que nossas reuniões se tornem monótonas
                      ...
                      ficamos entediados e, toda semana, ficamos aguardando ansiosamente
